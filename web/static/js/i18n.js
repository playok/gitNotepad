...
const i18n = {
    ...
    translations: {
        en: {
            ...
            'settings.sidebarFontSize': 'Sidebar Font Size',
            'settings.sidebarFontSizeDesc': 'Note list tree font size',
        ...
        ko: {
            ...
            'settings.sidebarFontSize': '사이드바 글꼴 크기',
            'settings.sidebarFontSizeDesc': '노트 목록 트리 글꼴 크기',
